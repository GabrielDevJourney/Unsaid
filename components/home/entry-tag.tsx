...
const TAG_STYLES: Record<TagName, string> = {
    Relationships: "border-red-300 bg-red-100 text-red-500",
    Work: "border-amber-300 bg-amber-100 text-amber-700",
    Family: "border-orange-300 bg-orange-100 text-orange-800",
    Health: "border-green-300 bg-green-100 text-green-700",
    Identity: "border-purple-300 bg-purple-100 text-purple-800",
    Goals: "border-blue-300 bg-blue-100 text-blue-500",
    Anxiety: "border-yellow-300 bg-yellow-100 text-yellow-700",
    Boundaries: "border-indigo-300 bg-indigo-100 text-indigo-500",
    ...
    Growth: "border-sky-300 bg-sky-100 text-sky-600",
    ...
    Vulnerability: "border-gray-300 bg-gray-100 text-gray-700",
};
